...
const EmptySearch = (props: SvgProps) => {
  ...
  return (
    ...
    />
    <Path
      id="f3818c68-126c-4685-b4e0-2450731ccc2a-229"
    ...
    />
    <Path
      id="addd02b1-b85b-481a-baea-1b0ba5ed9f4a-230"
    ...
    />
    <Path
      id="a42dc2a4-5fb2-4ea8-b2b3-ce81bc256782-231"
    ...
    />
    <Path
      id="b84687c4-e3b4-4975-8361-bf73c33c9ee5-232"
    ...
    />
    <Path
      id="e34cf46a-1d6c-4c41-b5e1-331fa5bf8d4c-233"
    ...
    />
    <Path
      id="e105039f-b7a6-49c8-8f81-87505f1b0ae5-234"
    ...
    />
    <Path
      id="ad9187ec-89e0-4b9d-a4fb-dc654c09bafe-235"
      ...
      fill={colors.surfaceVariant}
    />
    <Circle cx={315.11393} cy={422.84174} r={40} fill={colors.surface} />
    <Path
    ...
    <Path
      ...
      fill={colors.onSurface}
    />
    <Circle cx={486.89704} cy={378.42061} r={53.51916} fill={colors.primary} />
    <Path
